# E8T1 — User and settings persistence

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement persistence for user data and settings using Postgres. Write tests to tests/specs/E8T1.json and append the command to tests/commands.json.
