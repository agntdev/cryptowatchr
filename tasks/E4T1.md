# E4T1 — /price command for price checks

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the /price command to return the current price of a specified coin or all coins in the user's watchlist. Include timestamp and 24h change. Write tests to tests/specs/E4T1.json and append the command to tests/commands.json.
