# E2T1 — Add coin to watchlist

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement inline buttons for adding common coins (BTC, ETH, TON) and support for freeform ticker entry. Validate ticker input and handle unknown/typo cases with helpful suggestions. Write tests to tests/specs/E2T1.json and append the command to tests/commands.json.
