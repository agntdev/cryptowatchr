# E5T2 — Alert rule evaluation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the logic to evaluate alert rules against the latest price snapshots. Compute percent changes and check if rules are triggered. Write tests to tests/specs/E5T2.json and append the command to tests/commands.json.
