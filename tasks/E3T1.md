# E3T1 — Threshold alert creation

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the flow for creating threshold alerts. Users select a coin, direction (above/below), and enter a price in USD. Write tests to tests/specs/E3T1.json and append the command to tests/commands.json.
