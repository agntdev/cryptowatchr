# E8T2 — Watchlist and alert rule persistence

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement persistence for watchlists and alert rules using Postgres. Write tests to tests/specs/E8T2.json and append the command to tests/commands.json.
