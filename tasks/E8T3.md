# E8T3 — Price snapshot persistence and retention

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement persistence for price snapshots using Postgres. Implement a 30-day retention policy. Write tests to tests/specs/E8T3.json and append the command to tests/commands.json.
