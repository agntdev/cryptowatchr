# E1T2 — Timezone selection and fallback

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Allow users to select their timezone during onboarding, with a fallback to auto-detect. Store the timezone in the user's settings. Write tests to tests/specs/E1T2.json and append the command to tests/commands.json.
