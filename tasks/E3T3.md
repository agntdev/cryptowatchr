# E3T3 — Alert rule management

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement features for viewing and managing existing alert rules. Allow users to edit or delete alert rules. Write tests to tests/specs/E3T3.json and append the command to tests/commands.json.
