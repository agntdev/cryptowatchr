# E9T2 — Optional fallback to CoinAPI or CryptoCompare

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement optional fallback to CoinAPI or CryptoCompare if CoinGecko is unavailable or an API key is provided. Write tests to tests/specs/E9T2.json and append the command to tests/commands.json.
