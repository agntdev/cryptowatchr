# E5T3 — Alert suppression and cooldown

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement suppression logic for alerts during quiet hours and cooldown periods. Write tests to tests/specs/E5T3.json and append the command to tests/commands.json.
