# E2T2 — /list command to view watchlist

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 CWTR

Implement the /list command to display the user's watchlist with inline Remove buttons for each coin. Write tests to tests/specs/E2T2.json and append the command to tests/commands.json.
